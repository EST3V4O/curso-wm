const queries = require('./category')
...
module.exports = app => {
  ...
  const getById = (req, res) => {
    app.db('articles') 
      ...
      .first()
      .then(articles => {
        articles.content = article.content.toString()
